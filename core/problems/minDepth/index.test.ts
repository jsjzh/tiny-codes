...
const l5 = new TreeNode(2, null, new TreeNode(3, null, new TreeNode(4, null, new TreeNode(5, null, new TreeNode(6)))));

it('code1 test1', () => expect(code1(l1)).toBe(2));
it('code1 test2', () => expect(code1(l2)).toBe(2));
it('code1 test3', () => expect(code1(l3)).toBe(4));
it('code1 test4', () => expect(code1(l4)).toBe(3));
it('code1 test5', () => expect(code1(l5)).toBe(5));
